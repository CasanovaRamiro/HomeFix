...
-- AlterTable
ALTER TABLE `application` ADD COLUMN `offeredDuration` INTEGER NULL;

-- AlterTable
ALTER TABLE `post` ADD COLUMN `bidWeights` TEXT NULL,
    ...
    MODIFY `type` VARCHAR(191) NOT NULL DEFAULT 'client',
