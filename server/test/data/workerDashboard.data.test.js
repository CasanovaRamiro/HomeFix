...
import { findWorkerProfile, countWorkerReviews, countWorkerApplications, countNewJobsForWorker, countCompletedJobs, } from '../../src/infrastructure/database/workerDashboard.database.js';
let workerId;
let clientId;
beforeEach(async () => {
    await cleanDb();
...
const makePost = () => prisma.post.create({
    data: {
        userId: clientId,
        title: 'Test Post',
