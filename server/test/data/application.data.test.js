...
import { findApplicationsByWorker, deleteApplication, findApplicationsByPost, } from '../../src/infrastructure/database/application.database.js';
let workerId;
let clientId;
beforeEach(async () => {
    await cleanDb();
...
const makePost = (userId) => prisma.post.create({
    data: {
        userId,
        title: 'Test Post',
