...
beforeEach(() => cleanDb());
const makeWorker = (email, name, extra = {}) => createUser(email, name, 'hashed', { role: UserRole.Worker, ...extra });
const makeUser = (email, name, extra = {}) => createUser(email, name, 'hashed', { role: 'user', ...extra });
