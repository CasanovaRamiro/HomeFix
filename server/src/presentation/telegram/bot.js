...
export const createLinkCode = async (userId) => {
...
export const processLink = async (ctx, code) => {
...
export const handleTextMessage = async (ctx) => {
    ...
    if (user) {
        ...
        await ctx.reply('👋 ¡Hola! No tengo tu cuenta vinculada todavía.\n\n'
...
export const startBot = () => {
    try {
        ...
        bot.start(async (ctx) => {
            ...
            await ctx.reply('¡Bienvenido a HomeFix! 🛠️\n\n'
