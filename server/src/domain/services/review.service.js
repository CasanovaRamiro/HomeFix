...
export const createWorkerReview = async (postId, userId, input) => {
    ...
    if (input.applicationId) {
        ...
        const isAccepted = (application.status === ApplicationStatus.Accepted || application.status === ApplicationStatus.Completed) &&
...
export const createClientReview = async (applicationId, userId, input) => {
    validateRating(input.rating);
    validateDescription(input.description);
