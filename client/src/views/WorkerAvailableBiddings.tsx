...
export default function WorkerAvailableBiddings() {
  ...
  const s = {
    ...
    label: { fontSize: '0.8125rem', fontWeight: 600, color: '#64748B', marginBottom: '0.3rem', display: 'block' },
  }
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ marginBottom: '1rem' }}>
              ...
              <input style={s.input} type="number" placeholder="Ej: 250000" value={offeredCost}
                onChange={(e) => setOfferedCost(e.target.value)} />
            </div>

            <div style={{ marginBottom: '1rem' }}>
              <label style={s.label}>Duración estimada (días) *</label>
              <input style={s.input} type="number" placeholder="Ej: 15" value={offeredDuration}
                onChange={(e) => setOfferedDuration(e.target.value)} />
            </div>

            <div style={{ marginBottom: '1rem' }}>
              <label style={s.label}>Fecha de inicio estimada</label>
              <input style={s.input} type="date" value={offeredStartDate}
