...
export default function RegisterWorker() {
  ...
  const handleFinalSubmit = async () => {
    try {
      ...
      // 3. Redirigir a verificación KYC
      navigate('/kyc')
    } catch (err) {
      ...
      <main className="flex-1 flex items-center justify-center p-8">
        <div className="max-w-lg w-full space-y-6">
          ...
          <div className="flex items-center justify-center gap-3 md:gap-4">
            ...
            <div className={`w-8 md:w-12 h-0.5 ${step > 1 ? 'bg-accent' : 'bg-slate-200'}`} />
            ...
            <div className={`w-8 md:w-12 h-0.5 ${step > 2 ? 'bg-accent' : 'bg-slate-200'}`} />
          ...
          {step === 3 ? (
            <div className="space-y-4">
              ...
              <button
                ...
                className={`w-full relative p-5 md:p-6 rounded-2xl border-2 text-left cursor-pointer transition-all flex gap-4 ${
                  kycMethod === 'automatic'
              ...
              >
                ...
                <div className="w-12 h-12 bg-emerald-50 text-emerald-500 border border-emerald-100 rounded-xl flex-shrink-0 flex items-center justify-center mt-0.5">
              ...
              >
                ...
                <div className="w-12 h-12 bg-slate-100 text-slate-500 border border-slate-200 rounded-xl flex-shrink-0 flex items-center justify-center mt-0.5">
                  <User className="w-6 h-6" />
                </div>
                <div>
                  <h3 className="font-bold text-slate-900 text-base md:text-lg">
                    DNI Manual + Prueba de Vida
                  </h3>
                  <p className="text-slate-500 text-sm leading-relaxed mt-1">
              ...
              <div className="space-y-3 pt-4">
                <button
                  ...
                  className="w-full h-12 bg-[#7dddc5] hover:bg-[#6ecbb3] text-white font-bold rounded-xl flex items-center justify-center gap-2 transition-all shadow-sm cursor-pointer disabled:opacity-70 disabled:cursor-not-allowed"
                >
                  {isSubmitting ? (
                    <>
                ...
                <button
                  type="button"
                  onClick={() => setStep(2)}
                  className="w-full h-11 bg-transparent hover:bg-slate-100 text-slate-500 font-semibold rounded-xl flex items-center justify-center gap-2 transition-all border border-transparent cursor-pointer"
                >
              ...
              {/* Security Footer */}
              <div className="flex items-center justify-center gap-2 text-slate-400 text-xs md:text-sm pt-2 font-medium">
                ...
                {step === 1 ? (
                  <>
                    ...
                    <button
                      type="button"
                      onClick={handleNext}
                      className="w-full h-12 bg-accent hover:bg-accent-hover text-white font-semibold rounded-lg flex items-center justify-center gap-2 transition-colors cursor-pointer"
                    >
                      Continuar
                      <ArrowRight className="w-5 h-5" />
                    </button>
                  ...
                  <>
                    ...
                    <div className="flex gap-3">
                      <button
                        type="button"
                        onClick={() => setStep(1)}
                        className="flex-1 h-12 rounded-lg border border-slate-200 bg-white text-slate-900 font-medium flex items-center justify-center gap-2 hover:bg-slate-50 transition-colors cursor-pointer"
                      >
                        <ArrowLeft className="w-4 h-4" />
                        Atrás
                      </button>
                      <button
                        type="submit"
                        disabled={isSubmitting}
                        className="flex-1 h-12 bg-accent hover:bg-accent-hover text-white font-semibold rounded-lg flex items-center justify-center gap-2 transition-colors disabled:opacity-75 cursor-pointer"
                      >
                        {isSubmitting ? (
                          <>
                            <span className="w-5 h-5 border-2 border-white/40 border-t-white rounded-full animate-spin" />
