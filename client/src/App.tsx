  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/worker" element={<PrivateRoute><TrabajadorFeed /></PrivateRoute>} />
        <Route path="/worker/my-applications" element={<PrivateRoute><MisPostulaciones /></PrivateRoute>} />
        <Route path="/worker/posts/:id" element={<PrivateRoute><WorkerPostDetail /></PrivateRoute>} />
        <Route
