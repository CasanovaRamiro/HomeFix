...
import { Send, CheckCircle, XCircle, Copy, Loader2 } from 'lucide-react'
      ...
      {status === 'loading' && code ? (
        <div className="space-y-3">
          <p className="text-xs text-slate-500">
            Enviá este código al bot <span className="font-semibold text-slate-700">@HomeFixBot</span> en Telegram:
          </p>
